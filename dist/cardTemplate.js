            ...
            <div class="card-body">
              ...
              <div class="character__overlay">
                <ul class="list-unstyled">
                  ...
                  <li>Arma: ${element.weapon ? element.weapon : 'Sin epecificar'}</li>
                  <li>Destreza: ${element.dexterity ? element.dexterity : 'Sin especificar'} </li>
                  <li>Peloteo: ${element.brownNoseLevel
